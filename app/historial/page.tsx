    ...
    >
      ...
      {showHelp && (
        <div className="mt-1 bg-secondary flex ">
          <span className="p-4 italic text-justify">
            Este es el historial de compras, aquí se muestran los productos
            comprados comenzando por los más recientes. Puedes agregarlos a la
            lista tocando su botón
            <FaPlus size={16} className="inline ml-2 align-baseline" /> o
            eliminarlos definitivamente de la app tocando su botón{" "}
            <RiDeleteBin6Line
              size={16}
      ...
      {showHelp && (
        <div className="mt-1 bg-secondary flex mb-4">
          <span className="p-4 italic text-justify">
            El botón flotante permite ordenar los productos del historial
            alfabéticamente cuando muestra el ícono
            <FaSortAlphaDown
              size={16}
              className="inline ml-2 align-baseline"
            />{" "}
            o por orden de compra empezando por los más recientemente comprados
            cuando muestra el ícono{" "}
            <IoTimeOutline size={16} className="inline ml-2 align-baseline" /> .
          </span>
          <div className="flex justify-start mr-2">
            <button
              className="h-2 w-2 p-2 opacity-50"
